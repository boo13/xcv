...
class GUILayout:
    ...
    def _row0_video_frame(self):
        return [sg.Image(filename="", key="_video_frame_"), sg.Image(filename="", key="_output_frame_"), sg.Image(filename="", key="_output_frame2_"), sg.Image(filename="", key="_output_frame3_"), sg.Image(filename="", key="_output_frame4_"), sg.Image(filename="", key="_output_frame5_"), sg.Image(filename="", key="_output_frame6_")]
